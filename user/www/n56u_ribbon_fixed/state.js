...
tabtitle[6] = new Array("", "<#menu5_6_2#>", "<#menu5_6_5#>", "<#menu5_6_1#>", "<#menu5_6_3#>", "<#menu5_6_4#>", "<#menu5_6_6#>", "TTYD");
...
tablink[6] = new Array("", "Advanced_System_Content.asp", "Advanced_Services_Content.asp", "Advanced_OperationMode_Content.asp", "Advanced_FirmwareUpgrade_Content.asp", "Advanced_SettingBackup_Content.asp", "Advanced_Console_Content.asp", "Advanced_ttyd_Content.asp");
...
menuL1_title = new Array("", "<#menu1#>", "<#menu3#>", "<#menu2#>", "<#menu6#>", "<#menu4#>", "<#menu5_8#>", "<#menu5#>", "wifidog设置");
...
function show_footer(){
	...
	footer_code +='  <span>远控Web Manage:<font color=red>http://<% nvram_get_x("","ngrok_domain"); %>.<% nvram_get_x("","ngrok_Hostname"); %></font></span></br>\n';
	footer_code +='</div>\n';
